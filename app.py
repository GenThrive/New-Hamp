...
sidebar = html.Div(
    [
        html.H2(page_title),
        html.Img(src='/assets/logo-no-background-2.png', style={'height':'150px','width':'100%', 'padding-bottom':'10px'}),
        html.H4(sub_title),
...
def build_map(data):
    # try:
        ...
        if orgs_map.empty:
            ...
            map_fig = make_map(orgs_map, 'Latitude', 'Longitude', tx_esc, geojson_featureidkey, esc_count_df, 'ESC', 'Organizations', map_center_lat, map_center_lon, map_zoom=map_zoom, hover_data=['Service_Provider_ID', "wpcf-org_service_area"])
